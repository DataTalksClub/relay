"""Bind Relay's TaskRun projection to whichever tasks implementation is in use.
...
def _signal_modules():
    ...
    modules = []
    try:
        from django.tasks import signals as django_signals  # noqa: PLC0415 - optional implementation

        modules.append(django_signals)
    except ImportError:
        pass
    try:
        from django_tasks import signals as backport_signals  # noqa: PLC0415 - optional implementation
